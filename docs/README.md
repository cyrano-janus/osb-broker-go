...
| Measurement log with all findings · Messprotokoll mit allen Befunden | `cfk8s-platform/FINDINGS.md` |
| Development platform · Entwicklungsplattform | `cfk8s-platform/README.md` |
